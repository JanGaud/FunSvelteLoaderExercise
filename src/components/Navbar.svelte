...
<Navbar color="none" class="bg-[#ffffff59] backdrop-blur-2xl shadow-sm rounded-b-xl px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 start-0">
	<NavBrand href="/">
	...
	<NavHamburger />
	<NavUl>
		<NavLi nonActiveClass={linkClass} href="/">Exercice 1</NavLi>
		...
		<NavLi nonActiveClass={linkClass} href="/">Exercice 5</NavLi>
	</NavUl>
</Navbar>
